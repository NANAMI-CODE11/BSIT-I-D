...
public class PANONCILLON_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
                System.out.println("This program is made by Erich Panoncillon. BSIT-1D Student");
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Erich Panoncillon");
        System.out.println("------------------------------------");
