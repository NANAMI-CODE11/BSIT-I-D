...
public class ABATAYO_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Leonard Abatayo. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242044";
        String password = "May08";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Leonard Abatayo");
        System.out.println("------------------------------------");
