...
public class CARMELOTES_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
                System.out.println("This program is made by.Mark Arvi Carmelotes. BSIT-1D Student");
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Mark Arvi Carmelotes");
        System.out.println("------------------------------------");
