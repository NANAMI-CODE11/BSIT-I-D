...
public class IWAYAN_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Jonathan Galili. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242077";
        String password = "September 30";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Irnan Meynard Iwayan");
        System.out.println("------------------------------------");
