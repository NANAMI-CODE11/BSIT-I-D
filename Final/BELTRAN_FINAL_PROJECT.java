...
public class BELTRAN_FINALS_PROJECT {
    ...
    static void logIn() {
        String studentNumber = "20242043";
        String password = "Ilovetequila";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Maathew Boltron");
        System.out.println("------------------------------------");
