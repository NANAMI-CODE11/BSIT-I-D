...
public class LEBOSADA_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
                System.out.println("This program is made by.Jhn Bambi Lebosada. BSIT-1D Student");
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome John Bambi Lebosada");
        System.out.println("------------------------------------");
