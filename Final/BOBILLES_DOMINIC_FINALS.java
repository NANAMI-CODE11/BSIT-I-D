...
public class BOBILLES_FINALS_PROJECT {

    static int units = 24; 
    static String year = "1st Year"; 
    static String status = "IRREGULAR";  
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Dominic Bobilles. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242258";
        String password = "November11";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Dominic Bobilles");
        System.out.println("------------------------------------");
