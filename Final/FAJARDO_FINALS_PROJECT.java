...
public class FAJARDO_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Emerson Fajardo. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242061";
        String password = "August 1";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Emerson Fajardo");
        System.out.println("------------------------------------");
