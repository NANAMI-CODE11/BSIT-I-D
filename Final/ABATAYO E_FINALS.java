...
public class ABATAYO_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
                System.out.println("This program is made by. Elboy Abatayo. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242053";
        String password = "December 5";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Elboy Abatayo");
        System.out.println("------------------------------------");
