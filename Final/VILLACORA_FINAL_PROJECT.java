...
public class VILLACORA_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Edrian Villacora. BSIT-1D Student");
                
        }
    }

    static void register(){
        System.out.println("This program will be available soon Thankyouu");

    }

    static void logIn() {
        String studentNumber = "20242060";
        String password = "May 27";
        System.out.print("Student Number: ");
        Scanner sc1 = new Scanner(System.in);
        String inputStudentNumber = sc1.nextLine();

        if (!inputStudentNumber.equals(studentNumber)) {
            System.out.println("Error Invalid Student Number. Please try again.");
            logIn();
            return;
        }
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Edrian Villacora");
        System.out.println("------------------------------------");
        ...
        if (!editing.equals("Units") && !editing.equals("Year") && !editing.equals("Status") && !editing.equals("Exit")){
            ...
            System.out.println("        ");
             System.out.println("        ");
            System.out.println("Invalid input. Return to the portal");
            welcomePortal();
        }
