...
public class SOLTERAL_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
                System.out.println("This program is made by Jayfred Solteral. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242071";
        String password = "September 28";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Jayfred Solteral");
        System.out.println("------------------------------------");
        ...
        if (!editing.equals("Units") && !editing.equals("Year") && !editing.equals("Status")
                && !editing.equals("Exit")) {
            System.out.println("        ");
            System.out.println("        ");
            System.out.println("        ");
