...
public class MONTESCLAROS_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Kyth Nielzn Montesclaros. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242082";
        String password = "July 10";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Jonathan Galili");
        System.out.println("------------------------------------");
