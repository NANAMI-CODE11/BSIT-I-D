...
public class GIMENA_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Jeff Vincent Gimena");
    ...
    static void logIn() {
        String studentNumber = "20242072";
        String password = "Gimena123";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Jeff Gimena");
        System.out.println("------------------------------------");
