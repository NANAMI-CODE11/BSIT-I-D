...
public class TABUCANON_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Yrman Jhon Tabucanon. BSIT-1D Student");
    ...
    static void logIn() {
        String studentNumber = "20242070";
        String password = "Namryurasashi";
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Wazzup Yrman Jhon Tabucanon");
        System.out.println("------------------------------------");
