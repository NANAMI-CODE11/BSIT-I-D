...
public class MAHINAY_FINALS_PROJECT {
    ...
    static void intro() {
        ...
        switch (choices) {
            ...
            case 3:
            default:
            System.out.println("This program is made by Loujemay Mahinay. BSIT-1D Student");
    ...
    static void welcomePortal() {
        System.out.println("        ");
        System.out.println("Welcome Loujemay Mahinay");
        System.out.println("------------------------------------");
